...
public class UI {
	...
	public String promptCommand() {
		...
		while(true) {
			...
			if(Command.charAt(0) == 'G' ||  Command.charAt(0) == 'R' || Command.charAt(0) == 'W' ||  Command.charAt(0) == 'E' || Command.charAt(0) == 'A' || Command.charAt(0) == 'D' || Command.charAt(0) == 'M')
				break;
		}	
		System.out.print("\n");
		return Command;
	...
	public boolean showWelcomeMsg(String name) {
	    ...
	    System.out.print("        4) A 新增學生 (Add)\n");
	    System.out.print("        5) D 刪減學生 (Delete)\n");
	    System.out.print("        6) M 更改分數 (Modify)\n");
	    System.out.print("        7) E 離開選單 (Exit)\n\n");
		return true;
	}
